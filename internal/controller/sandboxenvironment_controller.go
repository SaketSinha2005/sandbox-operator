...
// SandboxEnvironmentReconciler reconciles a SandboxEnvironment object
type SandboxEnvironmentReconciler struct {
	client.Client
...
// the SandboxEnvironment object against the actual cluster state, and then
...
func (r *SandboxEnvironmentReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&sandboxv1alpha1.SandboxEnvironment{}).
		Complete(r)
}
